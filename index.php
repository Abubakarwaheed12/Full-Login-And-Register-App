            ...
            <div class="container">
                <div class="site-header-inner">
                    ...
                    <ul class="header-links list-reset m-0">
                        ...
                        <li>
                            <a class="button button-sm button-shadow" href="signup.php">Signup</a>
                            <a style="margin-left:3%"
                             class="button button-sm button-shadow" href="logout.php">logout</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <section class="hero text-light text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">WELCOME TO FULLY FUNCTIONAL PHP LOGIN AND REGISTER FORM</h1>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2022 Abu Bakar, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
